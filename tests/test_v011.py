...
def test_auto_recall_consumes_primed_flag(tmp_path):
    ...
    vault = _seed_vault(tmp_path, 1, project="cortex-plugin", body="auth bug fix constraint")
...
def test_auto_recall_topic_shift_uses_active_slice(tmp_path):
    ...
    vault = _seed_vault(tmp_path, 1, project="cortex-plugin", body="brief project forge workflow")
