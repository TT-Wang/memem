...
def print_stats(results: dict) -> None:
    ...
    print(f"=== memem vault low-quality memory identification ===")
...
def write_outputs(results: dict) -> None:
    ...
    lines = [
        ...
        "",
        f"Generated by `scripts/identify_low_quality_memories.py` (idempotent, safe to re-run).",
        "",
        "## Summary",
        "",
        f"| Metric | Count |",
